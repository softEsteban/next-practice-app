...
export default function AddUserForm() {
    ...
    if (addMutation.isError) return <Error message={JSON.stringify(addMutation.error)}></Error>
    if (addMutation.isSuccess) return <Success message="User created!"></Success>
